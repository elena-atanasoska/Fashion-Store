...
public class RegisterIntegrationTest {
    ...
    public void testGetSuccessfulRegistration() throws Exception {
        MockHttpServletRequestBuilder events = MockMvcRequestBuilders.post("/register")
                .param("username","pandilovaema")
                .param("password","username123")
                .param("repeatedPassword","username123")
                .param("name","name")
                .param("email","pandilovaema@gmail.com");

        this.mockMvc.perform(events)
                .andDo(MockMvcResultHandlers.print())
                .andExpect(MockMvcResultMatchers.status().is3xxRedirection())  // Expect a redirect
                .andExpect(MockMvcResultMatchers.redirectedUrl("/home"));  // Specify the redirected URL
    }
